...
automaton me.vldf.lsl.test.argAnnotations.Annotations : me.vldf.lsl.test.argAnnotations.Annotations {
    fun foo(@`org.jetbrains.annotations.NotNull` arg0: me.vldf.lsl.test.argAnnotations.Type, @`org.jetbrains.annotations.Nullable` arg1: me.vldf.lsl.test.argAnnotations.Type): void;
}
