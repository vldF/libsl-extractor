...
automaton org.jetbrains.annotations.Nls$Capitalization : org.jetbrains.annotations.Nls$Capitalization {
    fun values();
    
    fun valueOf(): org.jetbrains.annotations.Nls$Capitalization;
